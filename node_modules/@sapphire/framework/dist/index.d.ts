...
import { PieceOptions, Piece, PieceContext, AliasPiece, AliasPieceOptions, AliasPieceJSON, AliasStore, PieceJSON, Store, StoreRegistry } from '@sapphire/pieces';
...
export { Awaited } from '@sapphire/utilities';
import { Snowflake, Permissions, Message, Collection, PermissionResolvable, DMChannel, CategoryChannel, NewsChannel, ThreadChannel, TextChannel, StageChannel, VoiceChannel, GuildMember, Role, User, ClientOptions, ClientEvents, Client, Guild } from 'discord.js';
 ...
 * @since 1.0.0
 */
interface CommandOptions extends AliasPieceOptions, FlagStrategyOptions {
    /**
 ...
 * ```
 */
declare abstract class Listener<E extends keyof ClientEvents | symbol = ''> extends Piece {
    /**
     * The emitter, if any.
     * @since 2.0.0
     */
...
interface ListenerOptions extends PieceOptions {
    readonly emitter?: keyof Client | EventEmitter;
    readonly event?: string;
    readonly once?: boolean;
}
interface ListenerJSON extends PieceJSON {
    event: string;
    once: boolean;
}
